...
export default function ProfileScreen() {
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={[styles.scroll, { paddingBottom: isWeb ? 110 : 110 }]}
    ...
    >
      ...
      >
        ...
        <View style={styles.avatarWrap}>
          ...
          {!isEmployer && (
            <View
              style={[
                styles.scoreRing,
                { borderColor: score >= 80 ? "#34D399" : "#FCD34D" },
              ]}
            >
              <Text
                style={[
                  styles.scoreRingText,
                  { color: score >= 80 ? "#34D399" : "#FCD34D" },
                ]}
              >
                {score}%
              </Text>
        ...
        <Text style={styles.heroName}>
          {isEmployer && user.companyName ? user.companyName : user.name}
        </Text>
        ...
        {isEmployer ? user.companyDescription : user.bio ? (
          ...
          <TouchableOpacity onPress={() => setShowEditModal(true)}>
            <Text style={styles.heroAddBio}>
              + Add a short {isEmployer ? "company description" : "bio"}
            </Text>
          </TouchableOpacity>
        )}
        ...
        <>
          ...
          <View style={styles.card}>
            <View style={styles.cardHeader}>
              ...
              <TouchableOpacity style={styles.addBtn} onPress={() => setShowSkillModal(true)} activeOpacity={0.8}>
            ...
            {user.skills.length > 0 && <Text style={styles.skillHint}>{t("Tap a skill to remove it")}</Text>}
          </View>
          ...
          <View style={styles.card}>
            ...
            <DetailRow icon="language-outline" label={t("Language")} value={user.locale} />
            <DetailRow
          ...
          <View style={styles.card}>
            ...
            {user.resumeUploaded ? (
              <>
                <TouchableOpacity style={styles.resumeCard} onPress={() => setShowResumePreview(true)} activeOpacity={0.8}>
              ...
              <>
                <Text style={styles.resumeDesc}>{t("Upload your resume to stand out from other applicants.")}</Text>
                <TouchableOpacity style={styles.resumeBtn} onPress={handleUploadResume} activeOpacity={0.85}>
      ...
      {user.isAuthenticated && user.phone.startsWith("000") && (
        <TouchableOpacity style={styles.adminPanelBtn} onPress={() => router.push("/admin")} activeOpacity={0.85}>
              ...
              <>
                ...
                <View style={styles.optionGrid}>
                  {EDUCATION_OPTIONS.map((edu) => (
                    ...
                    >
                      <Text
                        style={[styles.optionChipText, editForm.education === edu && styles.optionChipTextActive]}
                      >
                        {edu}
                      </Text>
                    </TouchableOpacity>
      ...
      <Modal visible={showResumePreview} animationType="slide" presentationStyle="pageSheet">
        <View style={styles.modalContainer}>
          ...
          <View style={styles.resumePreviewFooter}>
            <TouchableOpacity style={styles.deleteResumeBtn} onPress={handleDeleteResume} activeOpacity={0.85}>
              <Ionicons name="trash-outline" size={16} color="#EF4444" />
              <Text style={styles.deleteResumeBtnText}>Delete Resume</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.uploadNewResumeBtn} onPress={handleUploadResume} activeOpacity={0.85}>
